...
public class EnnemiVue {
	...
	private void attribuerImageEnnemi() {
		if (ennemi instanceof Zombie) { 
			sprite = new ImageView("file:src/app/ressources2/zombie.png");
		//	pane.getChildren().add(s);
		}
		
		else if (ennemi instanceof Sorciere) { 
			sprite = new ImageView("file:src/app/ressources2/sorciere.png");
		//	pane.getChildren().add(s);
		}
		
		else if (ennemi instanceof Wither) { 
			sprite = new ImageView("file:src/app/ressources2/wither.png");
		//	pane.getChildren().add(s);
		}
		
		else if (ennemi instanceof Pigman) { 
			sprite = new ImageView("file:src/app/ressources2/pigman.png");
		//	pane.getChildren().add(s);
		}
		
		else if  (ennemi instanceof Squelette) { 
			sprite = new ImageView("file:src/app/ressources2/squlette.png");
		//	pane.getChildren().add(s);
		}	
	}
